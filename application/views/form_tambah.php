...
<div class="bg-contact3">
        <div class="container-contact3">
                <div class="wrap-contact3 validate-form">
                        <span class="contact3-form-title">Form Tambah Mahasiswa</span>
                        ...
                        <div class="wrap-input3 validate-input">
                                <input type="text" name="input_nim" value="<?php echo set_value('input_nim'); ?>" class="input3" placeholder="NIM">
                                <span class="focus-input3"></span>
                        </div>
                        
                        <div class="wrap-input3 validate-input">
                                <input type="text" name="input_nama" value="<?php echo set_value('input_nama'); ?>" class="input3" placeholder="Nama">
                                <span class="focus-input3"></span>
                        </div>
                        ...
                        <div class="wrap-contact3-form-radio">
                                ...
                                <div class="contact3-form-radio m-r-42 ml-4">
                                        <input type="radio" name="input_jeniskelamin" value="Laki-laki"<?php echo set_radio('jeniskelamin' ,'Laki-laki'); ?> id="laki-laki" class="input-radio3"><label for="laki-laki" class="label-radio3">Laki-laki</label>
                                </div>

                                <div class="contact3-form-radio">
                                        <input type="radio" name="input_jeniskelamin" value="Perempuan"<?php echo set_radio('jeniskelamin' ,'Perempuan'); ?> id="perempuan" class="input-radio3"><label for="perempuan" class="label-radio3">Perempuan</label>
                                </div>
                        </div>
                        
                        <div class="wrap-input3 validate-input">
                                <input type="text" name="input_telp" value="<?php echo set_value('input_telp'); ?>" class="input3" placeholder="Telepon">
                                <span class="focus-input3"></span>
                        </div>
                        
                        <div class="wrap-input3 validate-input">
                                <textarea name="input_alamat" class="input3" placeholder="Alamat"><?php echo set_value('input_alamat');?></textarea>
                                <span class="focus-input3"></span>
                        </div>
                        
                        <div class="container-contact3-form-btn">
                                <input type="submit" name="submit" value="Simpan" class="contact3-form-btn mr-3">
